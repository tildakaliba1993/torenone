...
/**
 * Open the Firm subscription checkout (R1,650/mo). Founding firms get the recurring discount
 * pre-applied (→ R999/mo for 12 cycles) — never shown as a coupon to type. `firm_id` rides in
 * customData so the webhook can map the resulting subscription to the firm.
 */
