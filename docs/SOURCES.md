...
| Task 1.17 pad footings | ⚠️ **CONCRETE design (SANS 10100-1) — a new standard surface.** Soil bearing (service + self-wt vs engineer-supplied allowable, **never assumed**); punching v_max=min(0.75√fcu,4.75); one-way nominal vc=0.75 MPa; flexure K≤0.156, z=d(0.5+√(0.25−K/0.9))≤0.95d, As=M/(0.87·fy·z) (BS 8110 lineage); γconc=24 kN/m³; defaults fcu=25 MPa, fy=450 MPa, cover 50 mm | SANS 10100-1 / BS 8110 practice — standard PDFs absent from `standards/` | **PROVISIONAL — concrete-experienced engineer sign-off required** |
